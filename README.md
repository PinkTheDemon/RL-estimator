...
改写后的代码在文件名后面都加了_copy，以于之前的代码区分开。在改写后，目前是得到了与EKF接近的训练参数，并且在不同随机数种子的仿真中效果都比较接近，因此先对此版本进行存档。并且附上效果图：

图1：EKF在随机数种子10086、490下的仿真效果

![](https://z4a.net/images/2023/08/16/EKF10086.png)

![](https://z4a.net/images/2023/08/16/EKF123456.png)

图2：NLS-RLF在随机数种子10086、490下的仿真效果
