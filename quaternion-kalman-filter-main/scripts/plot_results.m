...
images_path = '/暂时中转/temp/quaternion-kalman-filter-main/images';    % It is the folder where images will be saved.
                                                                        % *** !!! change this path if needed !!! ***
main_path = '/暂时中转/temp/quaternion-kalman-filter-main';             % It is the folder containing the source code.
                                                                        % *** !!! change this path if needed !!! ***
