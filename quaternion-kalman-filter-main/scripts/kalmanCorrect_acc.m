...
Q_hat_a_b__algorithm = 'sabatini';                           % <------- You can select/change the Q_hat_a_b algorithm here
...
q_hat__next_next = quatMultiplication(q_hat__next_prev, q_tilde_e); %% 个人注：应该等于(Omega(q_e)+eye(4))@q_hat__next_prev，运行时注意确认
...
x_hat_a__next_next(1:3) = zeros(3,1); %% 个人注：为什么？
