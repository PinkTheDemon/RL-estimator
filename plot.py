...
def plotStepMSE(isSave=False):
    ...
    ax1.plot(t_seq, e_MHE1, 'o', label='EKF-MHE(1)', color='red', linestyle='-')
    ax1.plot(t_seq, e_MHE2, 'o', label='EKF-MHE(2)', color='green', linestyle='-')
    ax1.plot(t_seq, e_MHE3, 'o', label='EKF-MHE(3)', color='purple', linestyle='-')
    ax1.plot(t_seq, e_MHE4, 'o', label='EKF-MHE(4)', color='orange', linestyle='-')
    ax1.plot(t_seq, e_MHE5, 'o', label='EKF-MHE(5)', color='black', linestyle='-')
    # ax1.plot(t_seq, e_MHE6, 'o', label='EKF-MHE(6)', color='yellow', linestyle='-')
    ax1.plot(t_seq, e_RA, 'o', label='RA-MHE', color='cyan', linestyle='-')
    ax2.plot(t_seq, e_EKF, 'o', label='EKF', color='blue', linestyle='-')
    ax2.plot(t_seq, e_MHE1, 'o', label='EKF-MHE(1)', color='red', linestyle='-')
    ax2.plot(t_seq, e_MHE2, 'o', label='EKF-MHE(2)', color='green', linestyle='-')
    ax2.plot(t_seq, e_MHE3, 'o', label='EKF-MHE(3)', color='purple', linestyle='-')
    ax2.plot(t_seq, e_MHE4, 'o', label='EKF-MHE(4)', color='orange', linestyle='-')
    ax2.plot(t_seq, e_MHE5, 'o', label='EKF-MHE(5)', color='black', linestyle='-')
