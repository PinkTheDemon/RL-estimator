...
def main() : 
    ...
    parser.add_argument("--lr_policy_min", default=0, type=float, help="minimum learning rate of policy net")
    ...
    dim_output = ds2do(args.state_dim)
    dim_input = args.state_dim+args.obs_dim+dim_output
    agent = RL_estimator(state_dim=dim_input, obs_dim=dim_output, noise=noise, hidden_layer=args.hidden_layer, STATUS='test')
